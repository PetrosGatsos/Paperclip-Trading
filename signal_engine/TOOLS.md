    ...
    # Signal Engine Tooling Guide

    ## Purpose
    This file defines how the **Signal Engine** should use tools in this project.

    ## Allowed tool behavior
    - read feature specs
- write signal specs and templates
- keep formulas explicit and reproducible
