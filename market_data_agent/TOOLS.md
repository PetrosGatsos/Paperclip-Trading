        ...
        # Market Data Agent Tooling Guide

        ## Purpose
        This file defines how the **Market Data Agent** should use tools in this project.

        ## Allowed tool behavior
        - read universe artifacts
- write schema and report templates
- surface anomalies instead of hiding them
