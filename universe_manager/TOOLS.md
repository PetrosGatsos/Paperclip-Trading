    ...
    # Universe Manager Tooling Guide

    ## Purpose
    This file defines how the **Universe Manager** should use tools in this project.

    ## Allowed tool behavior
    - read current universe artifacts
- write changelogs and snapshots in the workspace
- preserve history instead of silently replacing selections
