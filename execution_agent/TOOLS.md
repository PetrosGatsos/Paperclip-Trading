    ...
    # Execution Agent Tooling Guide

    ## Purpose
    This file defines how the **Execution Agent** should use tools in this project.

    ## Allowed tool behavior
    - read target portfolio and risk artifacts
- write execution flow docs
