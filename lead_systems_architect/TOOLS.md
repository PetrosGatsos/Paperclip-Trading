    ...
    # Lead Systems Architect Tooling Guide

    ## Purpose
    This file defines how the **Lead Systems Architect** should use tools in this project.

    ## Allowed tool behavior
    - create and update workspace markdown artifacts
- assign and review tasks
- maintain summary status docs
- never self-edit agent instruction paths during normal workflow
