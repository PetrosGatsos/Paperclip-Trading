    ...
    # Monitoring Agent Tooling Guide

    ## Purpose
    This file defines how the **Monitoring Agent** should use tools in this project.

    ## Allowed tool behavior
    - read architecture, risk, and execution docs
- write monitoring and alerting artifacts
- favor actionable signals over verbose noise
