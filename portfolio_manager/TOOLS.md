        ...
        # Portfolio Manager Tooling Guide

        ## Purpose
        This file defines how the **Portfolio Manager** should use tools in this project.

        ## Allowed tool behavior
        - read risk-approved artifacts
- write portfolio construction docs
- keep weighting rules explicit and auditable
